...
package org.kie.baaas.dfm.app.managedservices;
...
public class WireMockManagedServices implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        return Map.of("baaas.dfm.managed-services.endpoint", MOCK_SERVER.baseUrl(), "mock.managed-services.port", String.valueOf(MOCK_SERVER.port()));
    }

...
package org.kie.baaas.dfm.app.controller.modelmappers;
...
/**
 * Generates href style links for HATEOAS style navigation of the DaaS API.
 */
@ApplicationScoped
public class HrefGenerator {
    ...
    @Inject
    public HrefGenerator(DecisionFleetManagerConfig config) {
    ...
    public String generateDecisionHref(DecisionVersion decisionVersion) {
        ...
        try {
            ...
            throw new DecisionFleetManagerException("Failed to build HATEOAS href for DecisionVersion with version '" + version + "' for Decision '" + id + "'", e);
        }
    }
